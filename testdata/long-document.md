...
>
> Run `ml another.md` in a separate terminal. It will detect the running server and add the file.

> **Q: How do I change the port?**
>
> Use the `--port` flag: `ml --port 8080 file.md`

> **Q: Can I group files?**
>
> Yes, use the `--target` flag: `ml --target docs README.md CHANGELOG.md`
